...
<h4 align="center">
  ...
  <a href="https://docs.nexa.dev">Docs</a> |
  <a href="https://nexa.dev">Website</a>
</h4>
...
<h4 align="center">
  ...
  <a href="https://github.com/nexa-ai/nexa/blob/main/LICENSE">
    <img src="https://img.shields.io/badge/license-MIT-blue.svg" alt="Nexa is released under the MIT license." />
  </a>
  <a href="https://github.com/nexa-ai/nexa/blob/main/CONTRIBUTING.md">
...
**[Nexa](https://nexa.dev)** is the end-to-end open source production ready framework for quickly building LLM based voice driven conversational applications.


## Demo
https://github.com/nexa-ai/nexa/assets/1313096/2237f64f-1c5b-4723-b7e7-d11466e9b226



## Components
Nexa helps you create AI Voice Agents which can be instructed to do tasks beginning with:
...
Refer to the [docs](https://docs.nexa.dev/providers) for a deepdive into all supported providers.
...
2. Nexa server: for creating and handling agents 
...
Nexa uses LiteLLM package to support multiple LLM integrations.

These are the current supported LLM Provider Family:
https://github.com/nexa-ai/nexa/blob/477e08d6800dbf02931abeeea883d78451b7d7e2/nexa/providers.py#L29-L44
...
https://github.com/nexa-ai/nexa/blob/c8a0d1428793d4df29133119e354bc2f85a7ca76/nexa/providers.py#L7-L14
...
2. Add the telephony-specific input handler file in [input_handlers/telephony_providers](https://github.com/nexa-ai/nexa/tree/master/nexa/input_handlers/telephony_providers) writing custom functions extending from the [telephony.py](https://github.com/nexa-ai/nexa/blob/master/nexa/input_handlers/telephony.py) class
   1. This file will mainly contain how different types of event packets are being ingested from the telephony provider
3. Add telephony-specific output handler file in [output_handlers/telephony_providers](https://github.com/nexa-ai/nexa/tree/master/nexa/output_handlers/telephony_providers) writing custom functions extending from the [telephony.py](https://github.com/nexa-ai/nexa/blob/master/nexa/output_handlers/telephony.py) class
...
4. Lastly, you'll have to write a dedicated server like the example [twilio_api_server.py](https://github.com/nexa-ai/nexa/blob/master/local_setup/telephony_server/twilio_api_server.py) provided in [local_setup](https://github.com/nexa-ai/nexa/blob/master/local_setup/telephony_server) to initiate calls over websockets.
...
<a href="https://calendly.com/nexa/30min"><img alt="Schedule a meeting" src="https://cdn.cookielaw.org/logos/122ecfc3-4694-42f1-863f-2db42d1b1e68/0bcbbcf4-9b83-4684-ba59-bc913c0d5905/c21bea90-f4f1-43d1-8118-8938bbb27a9d/logo.png" /></a>


## Contributing
We love all types of contributions: whether big or small helping in improving this community resource.

1. There are a number of [open issues present](https://github.com/nexa-ai/nexa/issues) which can be good ones to start with
